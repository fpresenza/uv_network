...
if __name__ == '__main__':
    ...
    ax.plot(nodes, 2*hmax[:, 0], label=r'$\mathcal{D}(h_r)$', lw=1)
    ...
    ax.plot(nodes, 2*hmax[:, 1], label=r'$\mathcal{D}(h_r)$', lw=1)
    ...
    ax.plot(nodes, 2*hmax[:, 2], label=r'$\mathcal{D}(h_r)$', lw=1)
    ...
    ax.plot(nodes, load[:, 0], label=r'$\mathcal{L}(h_r)$', lw=1)
    # diam_ticks = range(2, int(diam[:, 0].max()) + 2, 2)
    # ax.set_yticks(diam_ticks)
    # ax.set_yticklabels(diam_ticks)
    ax.legend(
    ...
    ax.plot(nodes, load[:, 1], label=r'$\mathcal{L}(h_r)$', lw=1)
    # diam_ticks = range(2, int(diam[:, 0].max()) + 2, 2)
    # ax.set_yticks(diam_ticks)
    # ax.set_yticklabels(diam_ticks)
    ax.legend(
    ...
    ax.plot(nodes, load[:, 2], label=r'$\mathcal{L}(h_r)$', lw=1)
    # diam_ticks = range(2, int(diam[:, 0].max()) + 2, 2)
    # ax.set_yticks(diam_ticks)
    # ax.set_yticklabels(diam_ticks)
    ax.legend(
