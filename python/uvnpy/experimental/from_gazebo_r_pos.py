...
if __name__ == '__main__':
    ...
    parser.add_argument('-u', '--file1', default='r2dof4_vehicle1_position_local.csv', type=str, help='nombre del archivo uav1')
    parser.add_argument('-v', '--file2', default='r2dof4_vehicle2_position_local.csv', type=str, help='nombre del archivo uav2')
    parser.add_argument('-r', '--file3', default='r2dof4_target_position_local.csv', type=str, help='nombre del archivo target')
    ...
    data_1 = np.loadtxt(arg.dir+arg.file1, delimiter=',', usecols=(0,4,5,6,7,8,9,10), skiprows=1)
    data_2 = np.loadtxt(arg.dir+arg.file2, delimiter=',', usecols=(0,4,5,6,7,8,9,10), skiprows=1)
    ...
    # Animation
    if arg.animate:
        ani = Animation3D(time, xlim=(-15,15), ylim=(-15,15), zlim=(0,10), save=arg.save, slice=3)
